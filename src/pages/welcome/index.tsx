  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-blue-400 to-purple-400 text-white">
      ...
      <section className="mb-20 max-w-5xl mx-auto px-4">
        <p className="text-center mb-5 text-3xl font-bold">{utils.translate.use("pages.welcome.features.0.title")}</p>
        ...
        <div className="grid md:grid-cols-3 gap-5 text-xl">
          <div className="bg-white p-5 rounded-xl shadow-lg transition text-center text-gray-800">
            <p className="font-bold mb-2">{utils.translate.use("pages.welcome.features.0.main.0.title")}</p>
            <p>{utils.translate.use("pages.welcome.features.0.main.0.subTitle")}</p>
          </div>

          <div className="bg-white p-5 rounded-xl shadow-lg transition text-center text-gray-800">
            <p className="font-bold mb-2">{utils.translate.use("pages.welcome.features.0.main.1.title")}</p>
            <p>{utils.translate.use("pages.welcome.features.0.main.1.subTitle")}</p>
          </div>

          <div className="bg-white p-5 rounded-xl shadow-lg transition text-center text-gray-800">
            <p className="font-bold mb-2">{utils.translate.use("pages.welcome.features.0.main.2.title")}</p>
      ...
      <section className="mb-20 max-w-5xl mx-auto px-4">
        <p className="text-center mb-5 text-3xl font-bold">{utils.translate.use("pages.welcome.features.1.title")}</p>

        <div className="grid md:grid-cols-3 gap-5 text-xl">
          <div className="bg-white p-5 rounded-xl shadow-lg transition text-center text-gray-800">
            <p className="font-bold mb-2">{utils.translate.use("pages.welcome.features.1.main.0.title")}</p>
            <p>{utils.translate.use("pages.welcome.features.1.main.0.subTitle")}</p>
          </div>

          <div className="bg-white p-5 rounded-xl shadow-lg transition text-center text-gray-800">
            <p className="font-bold mb-2">{utils.translate.use("pages.welcome.features.1.main.1.title")}</p>
            <p>{utils.translate.use("pages.welcome.features.1.main.1.subTitle")}</p>
          </div>

          <div className="bg-white p-5 rounded-xl shadow-lg transition text-center text-gray-800">
            <p className="font-bold mb-2">{utils.translate.use("pages.welcome.features.1.main.2.title")}</p>
      ...
      <section className="p-10 mb-20 bg-white">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-10">
          ...
          <div className="md:w-1/2 order-1 md:order-2">
            <p className="text-3xl font-bold text-gray-800">{utils.translate.use("pages.welcome.hero.0")}</p>
          </div>
        </div>
      </section>
      ...
      <section className="p-10 mb-20 bg-white">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-1/2">
            <p className="text-3xl font-bold text-gray-800">{utils.translate.use("pages.welcome.hero.1")}</p>
          </div>
      ...
      <footer className="bg-black bg-opacity-30 py-10 mt-auto">
        <div className="max-w-5xl mx-auto px-4 flex flex-col md:flex-row items-center justify-between text-sm">
          <p className="text-center text-sm mb-5 md:mb-0">&copy; 2025 ue0ba1ya1sh3i {utils.title.use()}. All rights reserved.</p>
